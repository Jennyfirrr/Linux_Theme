...
- **Calculator & Emoji Picker**: Added `rofi-calc` and `rofi-emoji` to the installer dependencies and integrated them directly into the SysHub. Both use the unified `j/k` navigation and `h` return-to-hub logic.
