...
ZSH_HIGHLIGHT_STYLES[alias]='fg=#{{ZSH_CMD}}'
ZSH_HIGHLIGHT_STYLES[builtin]='fg=#{{ZSH_CMD}}'
ZSH_HIGHLIGHT_STYLES[function]='fg=#{{ZSH_CMD}}'
ZSH_HIGHLIGHT_STYLES[command]='fg=#{{ZSH_CMD}}'
ZSH_HIGHLIGHT_STYLES[precommand]='fg=#{{ZSH_CMD}},underline'
...
ZSH_HIGHLIGHT_STYLES[arg0]='fg=#{{ZSH_CMD}}'
