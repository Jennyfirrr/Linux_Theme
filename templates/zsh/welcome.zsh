...
function _caramel_welcome() {
  local c1='\e[38;5;{{ANSI_ACCENT1}}m'    # hot pink
  local c2='\e[38;5;{{ANSI_ACCENT2}}m'    # pastel pink
  local c3='\e[38;5;{{ANSI_ACCENT3}}m'    # rose
  local c4='\e[38;5;{{ANSI_ACCENT4}}m'    # blush
  local DM='\e[2;38;5;{{ANSI_ACCENT1}}m'  # dim pink
  local O='\e[0m'
